...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   pipex_multiple_doc.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: eperaita <eperaita@student.42urduliz.com>  +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/10/19 10:34:05 by eperaita          #+#    #+#             */
/*   Updated: 2021/10/29 10:17:32 by eperaita         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_re_in_out(int argc, char **argv, t_args *com)
{
	...
	{
		com->fd[0][0] = open("here_doc.txt", O_RDONLY);
		if (com->fd[0][0] < 0)
			exit(1);
	}
...
static void	ft_get_env(int argc, char **env, t_args *com)
{
	char	*path;
	char	*temp;
	int		i;
